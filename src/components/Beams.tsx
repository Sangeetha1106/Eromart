import { memo, forwardRef, useImperativeHandle, useEffect, useRef, useMemo, type FC, type ReactNode } from 'react';
...
const CanvasWrapper: FC<{ children: ReactNode }> = ({ children }) => (
  <Canvas dpr={[1, 1.5]} frameloop="always" gl={{ powerPreference: 'high-performance', antialias: false, preserveDrawingBuffer: true }} className="w-full h-full relative" style={{ width: '100%', height: '100%' }}>
    {children}
  </Canvas>
);
